...
Easily control your Lutron Caseta lights and scenes directly from your Unfolded Circle Remote. Powered by [uc-integration-api](https://github.com/aitatoi/integration-python-library).
...
- **Scenes:**  
  - Trigger Lutron scenes from your remote
...
1. **Download** the latest `.tar.gz` release from the [Releases](https://github.com/JackJPowell/uc-intg-lutron/releases) page.
...
docker run -d \
  ...
  ghcr.io/jackjpowell/uc-intg-lutron:latest
```
...
1. **Scan for Hubs:** The integration will automatically search for Lutron Caseta Smart Hubs on your network.
...
- **Need more help?**  
  Reach out on [Discord](https://discord.gg/zGVYf58) or open a [GitHub Issue](https://github.com/JackJPowell/uc-intg-lutron/issues).
...
- **GitHub Issues:** [Report bugs or request features](https://github.com/JackJPowell/uc-intg-lutron/issues)
